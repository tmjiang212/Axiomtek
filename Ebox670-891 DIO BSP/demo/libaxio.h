...
int ICO300_read_vcore(unsigned int *read_v);
int ICO300_read_5v(unsigned int  *read_v);
int ICO300_read_vsm(unsigned int  *read_v);
int ICO300_read_5vsb(unsigned int  *read_v);
int ICO300_read_sys_temp(unsigned int *data);
int ICO300_read_cpu_temp(unsigned int *date);
int ICO300_read_aux_temp(unsigned int *data);
/****************************************************/
...
int ICO300_set_DIO_mode(unsigned int mode);
/****************************************************/
void ICO300_print_DIO_status();
/****************************************************/
int ICO300_set_DO(unsigned int hi_low,int index);
/****************************************************/
int ICO300_get_DO(unsigned int *hi_low,int index);
/****************************************************/
int ICO300_get_DI(unsigned int *hilow,int index);
